...
public class FopFormaPagamento implements Serializable {
    ...
    public FopFormaPagamento() {
    }

    public FopFormaPagamento(Integer fopId) {
        this.fopId = fopId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FopFormaPagamento)) {
            return false;
        }
        FopFormaPagamento other = (FopFormaPagamento) object;
